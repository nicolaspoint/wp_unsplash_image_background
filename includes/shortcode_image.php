...
function unsplash_image( $atts ) {
    ...
    $ubi_result = '<div id="ubi_plugin" data-random_image="'.$random_image.'" class="'.$classes.'" style="height: '.$a['height'].'px"><div id="ubi_inner" '.$style_inner.'></div><div id="filter"></div><div class="ubi_title">'.$title.'</div></div>';
